...
function SelectLang({ rangeOfLangFuncSelect }) {
  const { setShowModal } = useModalContext();
  const closeShowToggle = () => {
  ...
  return (
    <div className="selectlang-total-outter-wrapper ">
      <div
        className="selectlang-total-inner-wrapper"
        ref={rangeOfLangFuncSelect}
      >
        <button
          className="selectlang-close-icon-wrapper"
          onClick={closeShowToggle}
        >
